...
\fancypagestyle{page}{%
	\fancyhf{}% clear all header and footer fields
	\fancyhead[L]{}
	\fancyhead[R]{\small Guhr, \textit{Lehreinheit: Literarische
Textannotation (mit CATMA) als Blended Learning}}
...
\hline[1pt]
\SetCell[c=4]{t,l}{\normalsize\textbf{Lehreinheit: Literarische
Textannotation (mit CATMA) als Blended Learning}} & & & \\
...
\hypersetup{
      pdftitle={Lehreinheit: Literarische Textannotation (mit CATMA) als
Blended Learning},
...
(Blended Learning)\footnote{Für mehr Informationen zu Blended
  Learning-Methoden, siehe (\citeproc{ref-graham_framework_2013}{Graham,
  Woodfield und Harrison 2013}).} und deckt einen Zeitraum von fünf
...
2024c}). Während der synchronen Lehrveranstaltungen wurde als kurzer
...
(\citeproc{ref-Hansen_figuren_2016}{Hansen 2016}).
...
(\citeproc{ref-Foliensatz_Figuren}{2024a})) & Formulieren einer
...
(\citeproc{ref-jackeRessourcenbeitragTagsetNarratologie2020}{2024d}))
...
Foliensatz Guhr (\citeproc{ref-Foliensatz_Figuren}{2024a})), in dem die
...
Phelan (\citeproc{ref-Phelan_2005}{2005}), die Unterscheidung von
flachen und runden Charakteren nach Forster
(\citeproc{ref-Forster_1949}{1949}) und das Figurenmodell nach Hansen
(\citeproc{ref-Hansen_2000}{2000}) mit seiner Unterscheidung von
...
Textannotation (Guhr
(\citeproc{ref-Foliensatz_Einfuxfchrung_Textannotation}{2024b})). Um den
...
(\citeproc{ref-jackeMethodenbeitragManuelleAnnotation2018}{2024b})).
...
Rapp (\citeproc{ref-rapp_manuelle_2017}{2017})).
...
(\citeproc{ref-rapp_manuelle_2017}{2017}) und Zinsmeister und Lemnitzer
(\citeproc{ref-zinsmeister_korpuslinguistik_2015}{2015})) sowie ein sehr
kurzer Ausblick auf die Evaluation des Annotationsprozesses und
Goldstandardannotationen (nach Jacke
(\citeproc{ref-jackeMethodenbeitragKollaborativesLiteraturwissenschaftliches2018}{2024c})).
...
(\citeproc{ref-jacke_ressourcenbeitrag_2024}{2024a})), das die
...
\bibitem[\citeproctext]{ref-Foliensatz_Einfuxfchrung_Textannotation}
